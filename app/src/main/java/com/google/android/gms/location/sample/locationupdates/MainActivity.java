...
public class MainActivity extends ActionBarActivity implements
    ...
    public void sendPost(){
        ...
        try {
            location.put("latitude", new Float(mCurrentLocation.getLatitude()));
            location.put("longitude", new Float(mCurrentLocation.getLongitude()));
            location.put("timestamp", mLastUpdateTime);
