...
public class LocationUpdatesService extends Service implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void sendPost(){
        ...
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                protected Map<String, String> getParams()
                {
                    ...
                    //sb.append("idSube: ").append(idsube).append("\n");
                    //params.put("id", idsube.toString() );
                    params.put("json", location.toString());
                    return params;
                }
            };
        ...
        /*String url = "http://10.105.231.23:8080/index.html";
        HashMap hm = new HashMap();
        hm.put("id", id.toString());
        try {
            performPostCall(url, hm);
        }catch (Exception e){
            sb.append("Http Get Exception: ").append(e.toString()).append("\n");
        }*/
